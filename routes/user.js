        ...
        bcrypt.hash(newUser.password, salt, function(err, hash) {
          ...
          newUser
            ...
            .then(result => {
              ...
              newUserActivation
              .save()
              .then(result => console.log(`new account activation started for userSideUuid:${userSideUuid} and serverSideUuid: ${serverSideUuid}`))
